...
def jsex():
    data=Data.poslednich10minut("CPU")
    return render_template("public/mojedata.tmpl",data=data)

@blueprint.route('/jsonpokus')
def jsexpokus():
    data=Data.poslednich10minut("DISKUSAGE")
    return render_template("public/mojedatapokus.tmpl",data=data)
